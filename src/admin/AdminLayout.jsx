          ...
          <div className="flex justify-between h-16">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                {navLinks.map(({ to, label }) => (
                  <Link
                    key={to}
                    to={to}
                    className="text-text-secondary hover:text-accent-blue hover:border-accent-blue
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-accent-red/10 hover:bg-accent-red/20 text-accent-red
