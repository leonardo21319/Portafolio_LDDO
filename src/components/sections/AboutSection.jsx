...
const TERM_LINES = [
  ...
  { delay: 1650, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-dim', t:'Frontend  ' }, { c:'t-blue', t:'React · TypeScript' }] },
  { delay: 2000, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-dim', t:'Mobile    ' }, { c:'t-blue', t:'Flutter · Dart' }] },
  { delay: 2350, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-dim', t:'Cloud     ' }, { c:'t-info', t:'AWS · Firebase · Azure' }] },
  { delay: 2700, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-dim', t:'Design    ' }, { c:'t-red',  t:'Figma · UX · Prototype' }] },
  { delay: 3050, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-dim', t:'QA        ' }, { c:'t-blue', t:'Postman · Jest' }] },
  ...
  { delay: 6000, parts: [{ c:'t-ok', t:'✓ ' }, { c:'t-blue', t:'Build success  ' }, { c:'t-dim', t:'12.4s' }] },
  { delay: 6500, parts: [{ c:'t-prompt', t:'❯ ' }, { c:'t-cursor', t:'' }] },
];

const SOFT_SKILLS = [
  { icon: '🧩', cls: 'si-blue', name: 'Resolución de Problemas', desc: 'Descompongo retos complejos en pasos claros y accionables.', delay: '.06s' },
  { icon: '🎯', cls: 'si-red',  name: 'Atención al Detalle',    desc: 'Pixel-perfect en UI, preciso en lógica de negocio.',         delay: '.12s' },
  { icon: '🤝', cls: 'si-cyan', name: 'Trabajo en Equipo',      desc: 'Comunicación clara, code reviews constructivos y colaboración ágil.', delay: '.18s' },
  { icon: '⚡', cls: 'si-mix',  name: 'Adaptabilidad',           desc: 'Aprendo tecnologías nuevas rápido y me ajusto a cualquier stack.', delay: '.24s' },
  { icon: '🗣️',cls: 'si-blue', name: 'Comunicación',            desc: 'Transmito ideas técnicas de forma clara a perfiles no técnicos.', delay: '.30s' },
  { icon: '🔁', cls: 'si-red',  name: 'Mentalidad Iterativa',   desc: 'Entrego valor rápido, itero con feedback y mejoro constantemente.', delay: '.36s' },
];
        ...
        <div className="about-grid">
          ...
          <div className="about-left" ref={leftRef}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div className="about-badge">
                ...
                <span className="badge-txt"><strong>Disponible</strong> para proyectos</span>
              </div>
            </div>
          ...
          <div className="about-content" ref={contentRef}>
            ...
            <p className="about-bio">
              ...
              en productos digitales que combinan <span className="hlr">diseño cuidado</span>
              {' '}y <strong>código limpio</strong>. Me especializo en crear interfaces que no solo
              funcionan bien, sino que <strong>se sienten bien</strong> al usarlas.
            </p>
            <p className="about-bio">
              Con experiencia en <strong>React</strong>, <strong>Flutter</strong> y servicios cloud
              como <strong>AWS y Firebase</strong>, disfruto cada etapa: desde el primer wireframe
