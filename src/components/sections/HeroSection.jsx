...
const TECH_ICONS = [
  ...
  /* 12 — PostgreSQL */
  { label:'PostgreSQL', dur:'3.4s', del:'2.75s', ic:'rgba(51,103,145,.6)', ig:'rgba(51,103,145,.18)',
    svg: <svg viewBox="0 0 24 24">
      <path d="M17.128 0a10.134 10.134 0 00-2.755.403l-.063.02A10.922 10.922 0 0012.6.258C11.422.238 10.41.524 9.594 1 8.79.721 7.122.24 5.364.336 4.14.403 2.804.775 1.814 1.80.824 2.825.305 4.364.5 6.362c.068.693.273 1.392.577 2.019.229.463.457.68.603.698.174.022.52-.177.842-.422C2.696 8.527 2.87 8.4 3.015 8.294a2.876 2.876 0 00.154.232C3.798 9.21 4.87 9.59 6.11 9.948l-.507.36c-.484.35-.862.932-.833 1.79.014.39.132.714.301.974-.21.618-.34 1.327-.364 2.084-.054 1.623.345 3.07 1.168 3.933a2.64 2.64 0 001.957.825c.636 0 1.207-.207 1.854-.702.512-.388.985-.984 1.407-1.757.4.424.829.741 1.272.95.672.32 1.49.4 2.37.216.782-.166 1.617-.655 2.263-1.533.643-.875 1.037-2.054 1.074-3.516a7.33 7.33 0 00-.186-1.877c.09-.115.171-.247.235-.392.468-1.044.387-2.28.183-3.1a6.827 6.827 0 00-.52-1.419c-.145-.287-.322-.577-.576-.775-.074-.057-.162-.103-.248-.148.008-.037.016-.073.024-.11.058-.282.09-.55.096-.793.014-.53-.047-1.01-.2-1.42C19.424.426 18.364.057 17.129 0zm.006.77c1.088.046 1.989.39 2.465 1.083.17.244.253.52.257.855a3.9 3.9 0 01-.016.477c-.232-.037-.473-.07-.73-.103l-.022-.003c-.434-.054-.88-.094-1.335-.117a23.27 23.27 0 00-1.753.013 28.742 28.742 0 00-1.67.148l-.078.01c-.426.059-.835.134-1.24.22a6.762 6.762 0 01.043-.465c.059-.473.196-.832.41-1.093.404-.492 1.103-.81 2.137-.985A8.777 8.777 0 0117.134.77zM8.562 1.1a7.374 7.374 0 011.976.339c-.49.45-.832 1.048-.995 1.81a6.52 6.52 0 00-.117.887c-.34.037-.667.08-.988.135-.068.012-.132.023-.196.034L8.2 4.32c-.292.052-.568.114-.838.186a6.272 6.272 0 00-.3.088 19.51 19.51 0 01-.064-.502c-.073-.697-.032-1.315.17-1.793.2-.477.555-.826 1.1-1.044A4.012 4.012 0 018.562 1.1z" fill="#336791"/>
      <path d="M12 5.5c.627 0 1.22.047 1.75.127.18.027.351.057.515.09.603.12 1.1.283 1.458.497.357.213.563.473.594.813.065.71-.42 1.63-1.29 2.49-.87.86-2.09 1.67-3.49 2.17-1.4.5-2.66.59-3.61.35-.95-.24-1.57-.8-1.63-1.51-.066-.71.42-1.63 1.29-2.49.87-.86 2.09-1.67 3.49-2.17A8.5 8.5 0 0112 5.5z" fill="#336791" opacity=".4"/>
    </svg> },
